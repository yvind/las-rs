...
## [0.11.1](https://github.com/gadomski/las-rs/compare/v0.11.0...v0.11.1) - 2026-08-25

### Other

- *(deps)* update laz requirement from 0.12.0 to 0.13.0 ([#155](https://github.com/gadomski/las-rs/pull/155))

## [0.11.0](https://github.com/gadomski/las-rs/compare/v0.10.0...v0.11.0) - 2026-08-11

### Other

- Add query functionality for copc-files ([#152](https://github.com/gadomski/las-rs/pull/152))
